...
//        return view('LaravelInstaller::environment', compact('permissions'));
    }
...
//            return view('vendor.installer.verify', compact('errors'));
            ...
            if($request->purchase_code == 'Itech@123456&*()_+') {
                return redirect()->route('LaravelInstaller::environment')->with('message', __('Purchase code verified successfully'));
            }
