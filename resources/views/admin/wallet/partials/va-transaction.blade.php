<div class="header-bar">
  <div class="table-title">
    <h3>Virtual Account History</h3>
  </div>
  <div class="form-group">
    <label for="status-va">Filter Status</label>
    <select class="form-control status-filter" id="status-va">
...
<div class="table-area">
  <div class="table-responsive">
      <table id="table-va" class="table table-borderless custom-table display text-center" style="width: 100%;">
          <thead>
          <tr>
              ...
              <th scope="col" class="desktop">{{__('Virtual Account')}}</th>
              <th scope="col" class="all">{{__('Expired At')}}</th>
