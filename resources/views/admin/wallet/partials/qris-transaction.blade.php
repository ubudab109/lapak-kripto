<div class="header-bar">
  <div class="table-title">
    <h3>QRIS Transaction History</h3>
  </div>
  <div class="form-group">
    <label for="status-ewallet">Filter Status</label>
    <select class="form-control status-filter" id="status-qris">
...
<div class="table-area">
  <div class="table-responsive">
      <table id="table-qris" class="table table-borderless custom-table display text-center" style="width: 100%;">
          <thead>
          <tr>
              ...
              <th scope="col" class="all">{{__('Generate Date')}}</th>
