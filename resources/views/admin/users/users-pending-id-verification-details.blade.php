        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    ...
                    $selfie = (isset($fields_name['selfie'])) ? $pending[array_search('selfie',array_keys($fields_name))]->photo : '';
                    ...
                    @if(isset($fields_name['nid_front']))
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xl-4">
                                <div class="card-wrapper w-auto">
                                    <div class="card-area">
                                        <img src="{{imageSrc($selfie,IMG_USER_VIEW_PATH)}}" class="img-fluid" alt="">
                                    </div>
                                    <h4>{{__('Selfie')}}</h4>
                                </div>
                            </div>
